 ...
 */
@Data
@TableName("mes_sop_template_control")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value = "mes_sop_template_control对象", description = "SOP模板步骤对应控件")
public class SopTemplateControl extends ILSEntity {
     ...
     * 控制逻辑名字
     */
    @Excel(name = "控制逻辑名字", width = 15)
    @ApiModelProperty(value = "控制逻辑名字", position = 5)
    @TableField("control_logic_name")
    private String controlLogicName;
    /**
     * 当使用的是投料控件时，实体对应物料编码，其他控件该字段为空。
     */
    @Excel(name = "当使用的是投料控件时，实体对应物料编码，其他控件该字段为空。", width = 15)
    @ApiModelProperty(value = "当使用的是投料控件时，实体对应物料编码，其他控件该字段为空。", position = 5)
     ...
     * 实体名称
     */
    @Excel(name = "实体名称", width = 15)
    @ApiModelProperty(value = "实体名称", position = 5)
    @TableField("entity_item_name")
