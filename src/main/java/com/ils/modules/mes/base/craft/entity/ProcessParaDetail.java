...
@TableName("mes_process_para_detail")
@ApiModel(value = "mes_process_para_detail", description = "工序关联工艺参数明细表")
public class ProcessParaDetail extends ILSEntity {

    /**
     * 工序参数主表id
     */
    @TableField("para_head_id")
    @ApiModelProperty(value = "工序参数主表id", position = 2)
    ...
    @ApiModelProperty(value = "工序id", position = 3)
