 ...
 */
@Data
@TableName("mes_machine_type_para_head")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value = "mes_machine_type_para_head对象", description = "设备类型关联参数主表")
public class MachineTypeParaHead extends ILSEntity {
