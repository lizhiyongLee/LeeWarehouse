...
@TableName("mes_work_shop_employee")
@ApiModel(value="mes_work_shop_employee对象", description="车间人员")
public class WorkShopEmployee extends ILSEntity {
    private static final long serialVersionUID = 1L;
    
	/**车间id*/
    @TableField("work_shop_id")
    @ApiModelProperty(value = "车间id", position = 2)
