...
@TableName("mes_work_shop")
@ApiModel(value="mes_work_shop对象", description="车间")
public class WorkShop extends ILSEntity {
    private static final long serialVersionUID = 1L;
    
	/**车间编码*/
    @Excel(name = "车间编码", width = 15)
    @TableField("shop_code")
    @ApiModelProperty(value = "车间编码", position = 2)
	private String shopCode;
	/**车间名称*/
    @Excel(name = "车间名称", width = 15)
    @TableField("shop_name")
    @ApiModelProperty(value = "车间名称", position = 3)
    ...
    @TableField("up_area")
    @ApiModelProperty(value = "上级区域", position = 5)
	private String upArea;
	/**上级区域*/
    @Excel(name = "上级区域", width = 15)
    @TableField("up_area_name")
    @ApiModelProperty(value = "上级区域", position = 6)
