...
@TableName("mes_route_line_para_detail")
@ApiModel(value = "mes_route_line_para_detail", description = "工艺路线工序参数明细表")
public class RouteLineParaDetail extends ILSEntity {
    /**
     * 主表id
     */
