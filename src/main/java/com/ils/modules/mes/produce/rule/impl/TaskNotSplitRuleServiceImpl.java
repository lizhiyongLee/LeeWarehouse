 ...
 *
 * @author fengyi
 * @date 2021年6月21日17:59:26
 */
@Service
public class TaskNotSplitRuleServiceImpl extends AbstractTaskSplitRuleService {
            ...
            if (CommonUtil.isEmptyOrNull(lstWorkCalendarVO)) {
                ...
                while (workCalendarIterator.hasNext()) {
                    ...
                    if (totalTime - calTotalTime > shiftDuration) {
                        ...
                        endDate = super.calcEndDate(totalTime, calTotalTime, workCalendarVO);
                        // 排程结束
