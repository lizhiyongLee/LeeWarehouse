 ...
 */
@Data
@TableName("mes_machine_repair_task_employee")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="mes_machine_repair_task_employee对象", description="维修任务计划执行人")
public class MachineRepairTaskEmployee extends ILSEntity {
