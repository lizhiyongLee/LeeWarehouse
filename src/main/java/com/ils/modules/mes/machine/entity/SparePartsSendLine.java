 ...
 */
@Data
@TableName("mes_spare_parts_send_line")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="mes_spare_parts_send_line对象", description="备件入库明细")
public class SparePartsSendLine extends ILSEntity {
	private static final long serialVersionUID = 1L;
    
	/**入库单表头id*/
	@Excel(name = "入库单表头id", width = 15)
    @ApiModelProperty(value = "入库单表头id", position = 2)
    @TableField("send_head_id")
