 ...
 */
@Data
@TableName("mes_machine_para_detail")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value = "mes_machine_para_detail对象", description = "设备关联参数")
public class MachineParaDetail extends ILSEntity {
    private static final long serialVersionUID = 1L;

    /**
     * 设备参数主表id
     */
    @Excel(name = "设备参数主表id", width = 15)
    @ApiModelProperty(value = "设备参数主表id", position = 2)
