 ...
 */
@Data
@TableName("mes_item_container_manage_detail")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value = "mes_item_container_manage_detail对象", description = "载具关联物料单元")
public class ItemContainerManageDetail extends ILSEntity {
     ...
     * 序号:某些场景用于标注标签的位置
     */
    @Excel(name = "序号:某些场景用于标注标签的位置", width = 15)
    @ApiModelProperty(value = "序号:某些场景用于标注标签的位置", position = 12)
    @TableField("sequence")
